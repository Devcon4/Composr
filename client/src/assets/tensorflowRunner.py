...
content_path = tf.keras.utils.get_file('content_{}.jpg'.format(sys.argv[1]), '{}{}.png'.format(address, sys.argv[1]))
style_path = tf.keras.utils.get_file('style_{}.jpg'.format(sys.argv[2]),'{}{}.png'.format(address, sys.argv[2]))
...
saveImage("{}.png".format(sys.argv[3]), image[0])
print("DONE")
# train_step(image)
# train_step(image)
# train_step(image)
